...
export default function Navigation({hide}: Props) {
  return (
    <div className="bg-white w-screen shadow h-13 box-border">
      <div className=" max-w-7xl min-w-6xl mx-auto py-4 flex items-center">
        ...
        {router.map((item) => (
          <NavLink className={(' mx-4 ')} to={item.path as To} key={item.path}>{item.title}</NavLink>
        ))}
      </div>
    </div>
  );
